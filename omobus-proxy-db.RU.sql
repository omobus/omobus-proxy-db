...
insert into issues(descr, extra_info, row_no) values('Отмена маршрута','[Начать рабочий день] → [Отмена маршрута]<br/>Отмена маршрута <b>автоматически аннулируется</b> при выполнении плановых посещений. Отмену маршрута за прошлые периоды может сделать руководитель.',8);
...
insert into sysholidays(h_date, country_id, descr) values('2020-01-01', 'RU', 'Новогодние каникулы');
insert into sysholidays(h_date, country_id, descr) values('2020-01-02', 'RU', 'Новогодние каникулы');
insert into sysholidays(h_date, country_id, descr) values('2020-01-03', 'RU', 'Новогодние каникулы');
insert into sysholidays(h_date, country_id, descr) values('2020-01-06', 'RU', 'Новогодние каникулы');
insert into sysholidays(h_date, country_id, descr) values('2020-01-07', 'RU', 'Рождество Христово');
insert into sysholidays(h_date, country_id, descr) values('2020-01-08', 'RU', 'Новогодние каникулы');
insert into sysholidays(h_date, country_id, descr) values('2020-02-24', 'RU', 'День защитника Отечества (перенос с 23 февраля на 24 февраля)');
insert into sysholidays(h_date, country_id, descr) values('2020-03-09', 'RU', 'Международный женский день (перенос с 8 марта на 9 марта)');
insert into sysholidays(h_date, country_id, descr) values('2020-05-01', 'RU', 'Праздник Весны и Труда');
insert into sysholidays(h_date, country_id, descr) values('2020-05-04', 'RU', 'Новогодние каникулы (перенос с 4 января на 4 мая)');
...
insert into sysholidays(h_date, country_id, descr) values('2020-01-02', 'KZ', 'Новый год');
insert into sysholidays(h_date, country_id, descr) values('2020-01-07', 'KZ', 'Рождество Христово');
insert into sysholidays(h_date, country_id, descr) values('2020-03-08', 'KZ', 'Международный женский день');
insert into sysholidays(h_date, country_id, descr) values('2020-03-21', 'KZ', 'Наурыз мейрамы');
insert into sysholidays(h_date, country_id, descr) values('2020-03-22', 'KZ', 'Наурыз мейрамы');
insert into sysholidays(h_date, country_id, descr) values('2020-03-23', 'KZ', 'Наурыз мейрамы');
insert into sysholidays(h_date, country_id, descr) values('2020-05-01', 'KZ', 'Праздник единства народа Казахстана');
insert into sysholidays(h_date, country_id, descr) values('2020-05-07', 'KZ', 'День защитника Отечества');
insert into sysholidays(h_date, country_id, descr) values('2020-05-09', 'KZ', 'День Победы');
insert into sysholidays(h_date, country_id, descr) values('2020-07-06', 'KZ', 'День столицы');
insert into sysholidays(h_date, country_id, descr) values('2020-08-30', 'KZ', 'День Конституции');
insert into sysholidays(h_date, country_id, descr) values('2020-12-01', 'KZ', 'День Первого Президента');
insert into sysholidays(h_date, country_id, descr) values('2020-12-16', 'KZ', 'День Независимости Казахстана');
insert into sysholidays(h_date, country_id, descr) values('2020-12-17', 'KZ', 'День Независимости Казахстана');

insert into sysholidays(h_date, country_id, descr) values('2020-01-01', 'BY', 'Новый год');
insert into sysholidays(h_date, country_id, descr) values('2020-01-07', 'BY', 'Рождество Христово (православное)');
insert into sysholidays(h_date, country_id, descr) values('2020-03-08', 'BY', 'День женщин');
insert into sysholidays(h_date, country_id, descr) values('2020-04-25', 'BY', 'Радуница - день поминовения усопших');
insert into sysholidays(h_date, country_id, descr) values('2020-05-01', 'BY', 'Праздник труда');
insert into sysholidays(h_date, country_id, descr) values('2020-05-09', 'BY', 'День Победы');
insert into sysholidays(h_date, country_id, descr) values('2020-07-03', 'BY', 'День Независимости Республики Беларусь');
insert into sysholidays(h_date, country_id, descr) values('2020-11-07', 'BY', 'День Октябрьской революции');
insert into sysholidays(h_date, country_id, descr) values('2020-12-25', 'BY', 'Рождество Христово (католическое)');

insert into sysholidays(h_date, country_id, descr) values('2020-01-01', 'UZ', 'Новый год');
insert into sysholidays(h_date, country_id, descr) values('2020-03-08', 'UZ', 'День женщин');
insert into sysholidays(h_date, country_id, descr) values('2020-03-23', 'UZ', 'Праздник Навруз');
insert into sysholidays(h_date, country_id, descr) values('2020-05-09', 'UZ', 'День Памяти и Почестей');
insert into sysholidays(h_date, country_id, descr) values('2020-09-01', 'UZ', 'День Независимости');
insert into sysholidays(h_date, country_id, descr) values('2020-10-01', 'UZ', 'День учителя и наставника');
insert into sysholidays(h_date, country_id, descr) values('2020-12-08', 'UZ', 'День Конституции');

insert into sysholidays(h_date, country_id, descr) values('2020-01-01', 'AZ', 'Новый год');
insert into sysholidays(h_date, country_id, descr) values('2020-01-02', 'AZ', 'Новый год');
insert into sysholidays(h_date, country_id, descr) values('2020-01-20', 'AZ', 'День всенародной скорби');
insert into sysholidays(h_date, country_id, descr) values('2020-03-08', 'AZ', 'Женский день');
insert into sysholidays(h_date, country_id, descr) values('2020-03-20', 'AZ', 'Праздник Новруз');
insert into sysholidays(h_date, country_id, descr) values('2020-03-21', 'AZ', 'Праздник Новруз');
insert into sysholidays(h_date, country_id, descr) values('2020-03-22', 'AZ', 'Праздник Новруз');
insert into sysholidays(h_date, country_id, descr) values('2020-03-23', 'AZ', 'Праздник Новруз');
insert into sysholidays(h_date, country_id, descr) values('2020-03-24', 'AZ', 'Праздник Новруз');
insert into sysholidays(h_date, country_id, descr) values('2020-05-09', 'AZ', 'День победы над фашизмом');
insert into sysholidays(h_date, country_id, descr) values('2020-05-24', 'AZ', 'Праздник Рамазан');
insert into sysholidays(h_date, country_id, descr) values('2020-05-25', 'AZ', 'Праздник Рамазан');
insert into sysholidays(h_date, country_id, descr) values('2020-05-28', 'AZ', 'День Республики');
insert into sysholidays(h_date, country_id, descr) values('2020-06-15', 'AZ', 'День национального спасения');
insert into sysholidays(h_date, country_id, descr) values('2020-06-26', 'AZ', 'День Вооруженных сил Азербайджанской Республики');
insert into sysholidays(h_date, country_id, descr) values('2020-07-31', 'AZ', 'Праздник Гурбан');
insert into sysholidays(h_date, country_id, descr) values('2020-08-01', 'AZ', 'Праздник Гурбан');
insert into sysholidays(h_date, country_id, descr) values('2020-11-09', 'AZ', 'День Государственного флага Азербайджанской Республики');
insert into sysholidays(h_date, country_id, descr) values('2020-12-31', 'AZ', 'День солидарности азербайджанцев мира');

insert into sysholidays(h_date, country_id, descr) values('2020-01-01', 'KG', 'Новый год');
insert into sysholidays(h_date, country_id, descr) values('2020-01-07', 'KG', 'Рождество Христово');
insert into sysholidays(h_date, country_id, descr) values('2020-02-23', 'KG', 'День защитника Отечества');
insert into sysholidays(h_date, country_id, descr) values('2020-03-08', 'KG', 'Женский день');
insert into sysholidays(h_date, country_id, descr) values('2020-03-21', 'KG', 'Народный праздник Нооруз');
insert into sysholidays(h_date, country_id, descr) values('2020-04-07', 'KG', 'День народной Апрельской революции');
insert into sysholidays(h_date, country_id, descr) values('2020-05-01', 'KG', 'Праздник труда');
insert into sysholidays(h_date, country_id, descr) values('2020-05-05', 'KG', 'День Конституции Кыргызской Республики');
insert into sysholidays(h_date, country_id, descr) values('2020-05-09', 'KG', 'День победы над фашизмом');
insert into sysholidays(h_date, country_id, descr) values('2020-08-31', 'KG', 'День независимости Кыргызской Республики');
insert into sysholidays(h_date, country_id, descr) values('2020-11-07', 'KG', 'Дни истории и памяти предков');
insert into sysholidays(h_date, country_id, descr) values('2020-11-08', 'KG', 'Дни истории и памяти предков');

delete from syswdmv;
insert into syswdmv(f_date, t_date, country_id, descr) values('2020-01-02', '2020-01-04', 'UZ', 'Перенос рабочего дня с 2 января на 4 января.');
insert into syswdmv(f_date, t_date, country_id, descr) values('2020-08-31', '2020-08-29', 'UZ', 'Перенос рабочего дня с 31 августа на 29 августа.');
...
insert into "L10n"(lang_id,obj_code,obj_id,obj_attr,str) values('ru','reminder','','sched/coaching:head:tomorrow','Завтра, $(date) у Вас запланировано <b>полевое обучение</b> с сотрудником:<br/><br/>$(timeline).<br/><br/>В случае отмены полевого обучения, не забудьте проинформировать сотрудника об этом.');
insert into "L10n"(lang_id,obj_code,obj_id,obj_attr,str) values('ru','reminder','','sched/coaching:head:today','Сегодня, $(date) у Вас запланировано <b>полевое обучение</b> с сотрудником:<br/><br/>$(timeline).<br/><br/>В случае отмены полевого обучения, не забудьте проинформировать сотрудника об этом.');
insert into "L10n"(lang_id,obj_code,obj_id,obj_attr,str) values('ru','reminder','','sched/coaching:staff:tomorrow','Завтра, $(date) с Вами у руководителя запланировано <b>полевое обучение</b>:<br/><br/>$(timeline).<br/><br/>В случае невозможности участия в полевом обучении, не забудьте проинформировать руководителя об этом.');
insert into "L10n"(lang_id,obj_code,obj_id,obj_attr,str) values('ru','reminder','','sched/coaching:staff:today','Сегодня, $(date) с Вами у руководителя запланировано <b>полевое обучение</b>:<br/><br/>$(timeline).<br/><br/>В случае невозможности участия в полевом обучении, не забудьте проинформировать руководителя об этом.');
