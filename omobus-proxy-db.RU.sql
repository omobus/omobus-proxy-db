...
insert into confirmation_types(confirmation_type_id, target_type_ids, descr, accomplished, succeeded)     values('0', array['notice']::uids_t, 'Я понял(-а) данное уведомление', 1, 1);
...
insert into confirmation_types(confirmation_type_id, target_type_ids, descr, accomplished, succeeded)     values('4', array['target:normal']::uids_t, 'Задача выполнена ПОЛНОСТЬЮ', 1, 1);
insert into confirmation_types(confirmation_type_id, target_type_ids, descr, photo_needed, accomplished, succeeded) values('5', array['target:strict']::uids_t, 'Задача выполнена ПОЛНОСТЬЮ (требуется фото)', 1, 1, 1);
insert into confirmation_types(confirmation_type_id, target_type_ids, descr, photo_needed, succeeded)     values('6', array['target:permanent']::uids_t, 'Задача выполнена ПОЛНОСТЬЮ (требуется фото)', 1, 1);
...
insert into confirmation_types(confirmation_type_id, target_type_ids, descr, accomplished, succeeded)     values('8', array['yes:no']::uids_t, 'ДА, т/точка будет участвовать в акции', 1, 1);
