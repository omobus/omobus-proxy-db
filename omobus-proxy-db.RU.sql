...
insert into sysholidays(h_date, country_id, descr) values('2021-01-01', 'RU', 'Новогодние каникулы');
insert into sysholidays(h_date, country_id, descr) values('2021-01-04', 'RU', 'Новогодние каникулы');
insert into sysholidays(h_date, country_id, descr) values('2021-01-05', 'RU', 'Новогодние каникулы');
insert into sysholidays(h_date, country_id, descr) values('2021-01-06', 'RU', 'Новогодние каникулы');
insert into sysholidays(h_date, country_id, descr) values('2021-01-07', 'RU', 'Рождество Христово');
insert into sysholidays(h_date, country_id, descr) values('2021-01-08', 'RU', 'Новогодние каникулы');
...
insert into sysholidays(h_date, country_id, descr) values('2021-11-05', 'RU', 'День народного единства');
insert into sysholidays(h_date, country_id, descr) values('2021-12-31', 'RU', 'Новогодние каникулы');

insert into sysholidays(h_date, country_id, descr) values('2021-01-01', 'KZ', 'Новый год');
insert into sysholidays(h_date, country_id, descr) values('2021-01-02', 'KZ', 'Новый год');
insert into sysholidays(h_date, country_id, descr) values('2021-01-04', 'KZ', 'Новый год');
insert into sysholidays(h_date, country_id, descr) values('2021-01-07', 'KZ', 'Рождество Христово');
insert into sysholidays(h_date, country_id, descr) values('2021-03-08', 'KZ', 'Международный женский день');
insert into sysholidays(h_date, country_id, descr) values('2021-03-22', 'KZ', 'Наурыз мейрамы');
insert into sysholidays(h_date, country_id, descr) values('2021-03-23', 'KZ', 'Наурыз мейрамы');
insert into sysholidays(h_date, country_id, descr) values('2021-03-24', 'KZ', 'Наурыз мейрамы');
insert into sysholidays(h_date, country_id, descr) values('2021-05-03', 'KZ', 'Праздник единства народа Казахстана');
insert into sysholidays(h_date, country_id, descr) values('2021-05-07', 'KZ', 'День защитника Отечества');
insert into sysholidays(h_date, country_id, descr) values('2021-05-10', 'KZ', 'День Победы');
insert into sysholidays(h_date, country_id, descr) values('2021-07-06', 'KZ', 'День столицы');
insert into sysholidays(h_date, country_id, descr) values('2021-07-20', 'KZ', 'Курбан-айта');
insert into sysholidays(h_date, country_id, descr) values('2021-08-30', 'KZ', 'День Конституции');
insert into sysholidays(h_date, country_id, descr) values('2021-12-01', 'KZ', 'День Первого Президента');
insert into sysholidays(h_date, country_id, descr) values('2021-12-16', 'KZ', 'День Независимости Казахстана');
insert into sysholidays(h_date, country_id, descr) values('2021-12-17', 'KZ', 'День Независимости Казахстана');

insert into sysholidays(h_date, country_id, descr) values('2021-01-01', 'BY', 'Новый год');
insert into sysholidays(h_date, country_id, descr) values('2021-01-07', 'BY', 'Рождество Христово (православное)');
insert into sysholidays(h_date, country_id, descr) values('2021-03-08', 'BY', 'День женщин');
insert into sysholidays(h_date, country_id, descr) values('2021-04-04', 'BY', 'Пасха (по календарю католической конфессии)');
insert into sysholidays(h_date, country_id, descr) values('2021-05-01', 'BY', 'Праздник труда');
insert into sysholidays(h_date, country_id, descr) values('2021-05-02', 'BY', 'Пасха (по календарю православной конфессии)');
insert into sysholidays(h_date, country_id, descr) values('2021-05-09', 'BY', 'День Победы');
insert into sysholidays(h_date, country_id, descr) values('2021-05-11', 'BY', 'Радуница - день поминовения усопших');
insert into sysholidays(h_date, country_id, descr) values('2021-07-03', 'BY', 'День Независимости Республики Беларусь');
insert into sysholidays(h_date, country_id, descr) values('2021-11-07', 'BY', 'День Октябрьской революции');
insert into sysholidays(h_date, country_id, descr) values('2021-12-25', 'BY', 'Рождество Христово (католическое)');

insert into sysholidays(h_date, country_id, descr) values('2021-01-01', 'UZ', 'Новый год');
insert into sysholidays(h_date, country_id, descr) values('2021-03-08', 'UZ', 'День женщин');
insert into sysholidays(h_date, country_id, descr) values('2021-03-21', 'UZ', 'Праздник Навруз');
insert into sysholidays(h_date, country_id, descr) values('2021-05-09', 'UZ', 'День Памяти и Почестей');
insert into sysholidays(h_date, country_id, descr) values('2021-05-13', 'UZ', 'Рамазан хаит');
insert into sysholidays(h_date, country_id, descr) values('2021-07-20', 'UZ', 'Курбан хаит');
insert into sysholidays(h_date, country_id, descr) values('2021-09-01', 'UZ', 'День Независимости');
insert into sysholidays(h_date, country_id, descr) values('2021-09-02', 'UZ', 'Дополнительные выхолные дни');
insert into sysholidays(h_date, country_id, descr) values('2021-09-03', 'UZ', 'Дополнительные выхолные дни');
insert into sysholidays(h_date, country_id, descr) values('2021-10-01', 'UZ', 'День учителя и наставника');
insert into sysholidays(h_date, country_id, descr) values('2021-12-08', 'UZ', 'День Конституции');

insert into sysholidays(h_date, country_id, descr) values('2021-01-01', 'AZ', 'Новый год');
insert into sysholidays(h_date, country_id, descr) values('2021-01-04', 'AZ', 'Новый год');
insert into sysholidays(h_date, country_id, descr) values('2021-01-25', 'AZ', 'День всенародной скорби');
insert into sysholidays(h_date, country_id, descr) values('2021-03-08', 'AZ', 'Женский день');
insert into sysholidays(h_date, country_id, descr) values('2021-03-20', 'AZ', 'Праздник Новруз');
insert into sysholidays(h_date, country_id, descr) values('2021-03-26', 'AZ', 'Праздник Новруз');
insert into sysholidays(h_date, country_id, descr) values('2021-03-22', 'AZ', 'Праздник Новруз');
insert into sysholidays(h_date, country_id, descr) values('2021-03-23', 'AZ', 'Праздник Новруз');
insert into sysholidays(h_date, country_id, descr) values('2021-03-24', 'AZ', 'Праздник Новруз');
insert into sysholidays(h_date, country_id, descr) values('2021-05-10', 'AZ', 'День победы над фашизмом');
insert into sysholidays(h_date, country_id, descr) values('2021-05-13', 'AZ', 'Праздник Рамазан');
insert into sysholidays(h_date, country_id, descr) values('2021-05-14', 'AZ', 'Праздник Рамазан');
insert into sysholidays(h_date, country_id, descr) values('2021-05-28', 'AZ', 'День Республики');
insert into sysholidays(h_date, country_id, descr) values('2021-06-15', 'AZ', 'День национального спасения');
insert into sysholidays(h_date, country_id, descr) values('2021-06-28', 'AZ', 'День Вооруженных сил Азербайджанской Республики');
insert into sysholidays(h_date, country_id, descr) values('2021-07-20', 'AZ', 'Праздник Гурбан');
insert into sysholidays(h_date, country_id, descr) values('2021-07-21', 'AZ', 'Праздник Гурбан');
insert into sysholidays(h_date, country_id, descr) values('2021-11-08', 'AZ', 'день Победы Азербайджана');
insert into sysholidays(h_date, country_id, descr) values('2021-11-09', 'AZ', 'День Государственного флага Азербайджанской Республики');
insert into sysholidays(h_date, country_id, descr) values('2021-12-31', 'AZ', 'День солидарности азербайджанцев мира');

insert into sysholidays(h_date, country_id, descr) values('2021-01-01', 'KG', 'Новый год');
insert into sysholidays(h_date, country_id, descr) values('2021-01-07', 'KG', 'Рождество Христово');
insert into sysholidays(h_date, country_id, descr) values('2021-02-23', 'KG', 'День защитника Отечества');
insert into sysholidays(h_date, country_id, descr) values('2021-03-08', 'KG', 'Женский день');
insert into sysholidays(h_date, country_id, descr) values('2021-03-21', 'KG', 'Народный праздник Нооруз');
insert into sysholidays(h_date, country_id, descr) values('2021-04-07', 'KG', 'День народной Апрельской революции');
insert into sysholidays(h_date, country_id, descr) values('2021-05-01', 'KG', 'Праздник труда');
insert into sysholidays(h_date, country_id, descr) values('2021-05-05', 'KG', 'День Конституции Кыргызской Республики');
insert into sysholidays(h_date, country_id, descr) values('2021-05-10', 'KG', 'День победы над фашизмом');
insert into sysholidays(h_date, country_id, descr) values('2021-08-31', 'KG', 'День независимости Кыргызской Республики');
insert into sysholidays(h_date, country_id, descr) values('2021-11-07', 'KG', 'Дни истории и памяти предков');
insert into sysholidays(h_date, country_id, descr) values('2021-11-08', 'KG', 'Дни истории и памяти предков');

delete from syswdmv;
insert into syswdmv(f_date, t_date, country_id, descr) values('2021-02-22', '2021-02-20', 'RU', 'Перенос рабочего дня с 22 февраля на 20 февраля.');
insert into syswdmv(f_date, t_date, country_id, descr) values('2021-01-08', '2021-01-16', 'BY', 'Перенос рабочего дня с 8 на 16 января.');
insert into syswdmv(f_date, t_date, country_id, descr) values('2021-05-10', '2021-05-15', 'BY', 'Перенос рабочего дня с 10 на 15 мая.');
insert into syswdmv(f_date, t_date, country_id, descr) values('2021-03-22', '2021-03-27', 'UZ', 'Перенос рабочего дня с 22 на 27 марта.');
